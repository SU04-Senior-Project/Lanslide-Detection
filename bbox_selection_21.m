...
for num=1:70
    ...
    %RGB = insertShape(I,'Rectangle',box_a);
    %RGB = insertShape(RGB,'Rectangle',box_b);
    %RGB = insertShape(RGB,'FilledRectangle',result_box,'Color','green');
    %imshow(RGB)
    
    result_2_bboxes_rgb_slope_v41{num} = result_box;
    %iou_rgb_ndvi_bboxes_ver41(t,1) = gt_intersect_overlapRatio;
